    ...
    <div className="max-w-3xl mx-auto px-4 py-10 text-white">
      ...
      <section className="mb-8">
        ...
        <p className="text-zinc-300 leading-relaxed">
          Match Master est développé par Raïssa Ali. Pour toute question
          relative à vos données personnelles, vous pouvez nous contacter à :{" "}
          <span className="text-amber-700">[haliba.raissa@hotmail.fr]</span>.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-zinc-300 leading-relaxed">
          Vos données sont conservées tant que votre compte est actif. Lors de
          la suppression de votre compte, toutes vos données personnelles sont
      ...
      <section className="mb-8">
        ...
        <p className="text-zinc-300 leading-relaxed">
          Match Master utilise un unique cookie de session, strictement
          nécessaire au maintien de votre connexion. Ce cookie est
          automatiquement supprimé à la déconnexion. Aucun cookie de suivi, de
          publicité ou d'analyse n'est utilisé.
        </p>
      </section>
